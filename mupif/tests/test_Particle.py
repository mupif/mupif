...
class ParticleSet_TestCase(unittest.TestCase):
    def setUp(self):
        ...
        self.ps1 = particle.ParticleSet (id=ParticleSetID.PSID_ParticlePositions, size=5, xc=(0,1,2,3,4), yc=(1,2,3,4,5), zc=(2,3,4,5,6), code=(10,11,12,13,14), rvesize = 4, inclusionsize=0.5, attributes=dict(colour=("red", "green", "gray", "black", "magenta")))
