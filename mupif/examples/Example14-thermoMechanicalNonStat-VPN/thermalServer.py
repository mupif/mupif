...
PyroUtil.runAppServer(server=cfg.server, port=cfg.serverPort, nathost=cfg.server, natport=cfg.serverPort, nshost=cfg.nshost, nsport=cfg.nsport, nsname='thermal', hkey=cfg.hkey, app=thermal)
