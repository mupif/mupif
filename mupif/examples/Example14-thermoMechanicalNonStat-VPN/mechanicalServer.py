...
PyroUtil.runAppServer(server=hostname, port=cfg.serverPort2, nathost=hostname, natport=cfg.serverPort2, nshost=cfg.nshost, nsport=cfg.nsport, nsname='mechanical', hkey=cfg.hkey, app=mechanical)
