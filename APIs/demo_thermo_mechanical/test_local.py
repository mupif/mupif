...
if __name__ == "__main__":
    ...
    ttop = mp.ConstantProperty(value=500., propID=mp.DataID.PID_Temperature, valueType=mp.ValueType.Scalar, unit=mp.U.deg_C, time=None)
    tbottom = mp.ConstantProperty(value=-500., propID=mp.DataID.PID_Temperature, valueType=mp.ValueType.Scalar, unit=mp.U.deg_C, time=None)
    tm.set(ttop, 'temperature_top')
    tm.set(tbottom, 'temperature_bottom')
