...
if len(sys.argv) == 3:
    ...
    class Workflow13(mp.workflow.Workflow):
        ...
        def initialize(self, workdir='', metadata={}, validateMetaData=True, **kwargs):
            ...
            self.ns = mp.pyroutil.connectNameServer(nshost=nshost, nsport=nsport)
    ...
    print('Execute this script as "python main_demo.py 2.0 3.0" to calculate the result of 2.0 * 3.0')
