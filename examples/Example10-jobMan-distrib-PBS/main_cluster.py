...
jobMan = mp.pyroutil.connectJobManager(ns, 'Mupif.JobManager@Example10')
...
while compute:
    ...
    time_param = mp.ConstantProperty(value=(var_time.inUnitsOf(mp.U.s).getValue(),), propID=mp.DataID.PID_Time, valueType=mp.ValueType.Scalar, unit=mp.U.s, time=None, objectID=0)
