...
class Workflow10(mp.workflow.Workflow):
    ...
    def initialize(self, workdir='', metadata={}, validateMetaData=True, **kwargs):
        ...
        self.ns = mp.pyroutil.connectNameServer(nshost='172.22.2.1', nsport=10000)
        self.daemon = mp.pyroutil.getDaemon(self.ns)

        # initialization code of model_1
        self.model_1_jobman = mp.pyroutil.connectJobManager(self.ns, 'Mupif.JobManager@Example10_cluster')
        try:
